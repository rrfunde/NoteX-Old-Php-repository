...
addCollection=function()
{
    ...
    if (Collection != null) {
        ...
        var url = "localhost/X/Material/newCollection.php";
        ...
        hr.onreadystatechange = function() {
            if(hr.readyState == 4 && hr.status == 200) {  // ajax request completed
                var return_data = hr.responseText;
                 var path="index.php?name=".concat(Collection);
...
//input.name = "post";
   ...
   /* button1.className="serverSubmit";*/
    ...
    button1.onclick = function(){
        ...
        var url = "Editserve.php";
        var subject = getParameterByName('name');
        var params= "id="+clicked_id+"&subject="+subject+"&solution="+encodeURIComponent(temp);
        //   var params="solution="+temp.toString();
        hr.open("POST", url, true);
        hr.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
